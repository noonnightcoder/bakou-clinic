...
class ItemExpireController extends Controller
{
	/**
	...
	public function actionAdmin()
	{
		...
		if (isset($_GET['ItemExpire'])) {
			$model->attributes=$_GET['ItemExpire'];
		}
	 ...
	 * @param ItemExpire $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if (isset($_POST['ajax']) && $_POST['ajax']==='item-expire-form') {
