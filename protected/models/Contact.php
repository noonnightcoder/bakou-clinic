...
class Contact extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('contact_id, first_name, middle_name, last_name, display_name, phone_number, email, contact_image, type, address_line_1, address_line_2, city, state, postal_code, country', 'safe', 'on'=>'search'),
		);
	}
